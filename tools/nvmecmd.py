...
examples = """examples:
  ...
  nvmecmd --output nvmecmd.db      # Capture NVMe commands in sqlite database
  nvmecmd parser
    --file nvmecmd.db
  ...
  nvmecmd parser
    --file nvmecmd.db
    --select "algn"
    --groupby "algn"               # Print alignment in a power-of-2 histogram
  nvmecmd parser
    --file nvmecmd.db
    --select "*"
    --algn "< 16384"               # Query only commands with an alignment
                                   # < 16k
  nvmecmd parser
    --file nvmecmd.db
    --select "*"
    --len ">= 8192"
    --algn "< 16384"               # Query only commands with a length >= 8k
                                   # and alignment < 16k
"""
